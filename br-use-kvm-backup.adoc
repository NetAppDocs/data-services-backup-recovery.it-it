...
* Crea gruppi di protezione per gestire le operazioni di backup e ripristino per un set di risorse. Vedi link:br-use-kvm-protection-groups.html["Gestisci i gruppi di protezione KVM in NetApp Backup and Recovery"] per maggiori informazioni.
