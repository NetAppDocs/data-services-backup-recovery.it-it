...
* È possibile ripristinare una *cartella* da snapshot di storage replicato o storage a oggetti in un volume del sistema originale, in un volume di un sistema diverso che utilizza lo stesso account cloud oppure in un volume su un sistema ONTAP locale. Il ripristino di cartelle da snapshot locali non è supportato.
