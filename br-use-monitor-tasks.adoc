...
Un processo di backup del ciclo di vita tiene traccia di tutti gli snapshot eliminati o in coda per l'eliminazione. A partire da ONTAP 9.13, è possibile visualizzare tutti i tipi di lavoro denominati "Retention" nella pagina Job Monitoring.
