...
* Se usi Backup and Recovery con NetApp Console, puoi abbonarti alla licenza pay-as-you-go (PAYGO) oppure acquistare una licenza bring-your-own-license (BYOL).
...
Configura le licenze per NetApp Backup and Recovery.
...
=== Utilizza un contratto annuale con licenze marketplace o BYOL
...
== Configura le licenze per la distribuzione locale di NetApp Backup and Recovery

Configura le licenze per la versione locale di NetApp Console.
...
Usi la distribuzione locale della NetApp Console per gestire le licenze BYOL. Puoi aggiungere nuove licenze, aggiornare quelle esistenti e visualizzare lo stato delle licenze dalla Console.
