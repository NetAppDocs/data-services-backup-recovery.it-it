...
[role="lead"]
A seconda che tu stia usando NetApp Console o NetApp Console (deployement locale), puoi ottenere la licenza per NetApp Backup and Recovery acquistando un abbonamento pay-as-you-go (PAYGO) o annuale al marketplace per *NetApp Intelligent Services* dal tuo cloud provider, oppure acquistando una bring-your-own-license (BYOL) da NetApp. È necessaria una licenza valida per attivare NetApp Backup and Recovery su un sistema, per creare backup dei tuoi dati di produzione e per ripristinare i dati di backup su un sistema di produzione.
...
* Acquista una licenza diretta, nota anche come bring-your-own-license (BYOL), da NetApp. Questa opzione si applica sia a NetApp Console che alla distribuzione locale della Console.
...
Usi la NetApp Console o la distribuzione locale della Console per gestire le licenze BYOL. Puoi aggiungere nuove licenze, aggiornare quelle esistenti e visualizzare lo stato delle licenze dalla Console.
