...
| Cloud Volumes ONTAP in storage a oggetti compatibile S3  a| 
* Cloud Volumes ONTAP in storage a oggetti compatibile S3
* Sistema ONTAP in sede

| storage a oggetti compatibile S3 
|===
...
| storage a oggetti compatibile S3  a| 
* Cloud Volumes ONTAP in storage a oggetti compatibile S3
* Sistema ONTAP in sede
