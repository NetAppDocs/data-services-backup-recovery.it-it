...
[role="lead"]
Monta un punto di ripristino del database Oracle quando hai bisogno di accedere al database in uno stato controllato per le operazioni di ripristino. Se la catalogazione automatica è disabilitata, puoi catalogare manualmente i metadati del punto di ripristino nel catalogo di ripristino RMAN.
...
== Smonta un punto di ripristino di database Oracle
