...
* Crea gruppi di protezione per gestire le operazioni di backup e ripristino per un set di risorse. Vedi link:br-use-hyperv-protection-groups.html["Crea e gestisci i gruppi di protezione Hyper-V in NetApp Backup and Recovery"] per maggiori informazioni.
