...
+
*** *Modifica posizione di archiviazione predefinita*: Abilita questa opzione per ripristinare un backup dell'archivio di oggetti in una macchina virtuale di archiviazione diversa nel caso in cui la posizione di archiviazione di origine non sia raggiungibile o sia piena. Scegli un cluster, una macchina virtuale di archiviazione o un aggregate diverso da utilizzare.
