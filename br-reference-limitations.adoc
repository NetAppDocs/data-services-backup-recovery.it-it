...
[role="lead"]
Le limitazioni note identificano funzioni non supportate da questa versione di NetApp Backup and Recovery o che non interagiscono correttamente con essa. Esamina attentamente queste limitazioni.
