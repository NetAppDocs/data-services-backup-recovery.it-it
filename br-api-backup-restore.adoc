...
+
Assicurati di generare il refresh token dal seguente link: https://services.cloud.netapp.com/refresh-token/. Il refresh token è una stringa alfanumerica che utilizzerai per generare un token utente.
