...
.. *Impostazioni Hyper-V*: Fai quanto segue:
+
...
... Aggiungi un nuovo host Hyper-V immettendo il FQDN o l'indirizzo IP dell'host e selezionando un agente Console e le credenziali. Se il FQDN non è risolvibile dall'agente Console, usa l'indirizzo IP. Per i cluster di failover, inserisci l'indirizzo IP di gestione del cluster.


.. *Impostazioni avanzate*: Facoltativamente, inserisci un percorso di installazione per il plug-in Hyper-V NetApp.
