...
* *Carichi di lavoro VMware (con nuova interfaccia utente senza SnapCenter Plug-in per VMware vSphere)*:
+
** Proteggi le tue VM VMware e i tuoi datastore con NetApp Backup and Recovery.
** Esegui il backup dei carichi di lavoro VMware su Amazon Web Services S3 o StorageGRID.
...
* Microsoft Azure Blob (non disponibile per carichi di lavoro VMware)
* StorageGRID
* ONTAP S3 (non disponibile per carichi di lavoro VMware)
