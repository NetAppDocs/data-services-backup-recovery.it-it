...
. Verifica l'idoneità dei volumi. Il sistema controlla se i volumi sono idonei per la risincronizzazione. Se un volume non è idoneo, significa che non sono stati definiti i criteri comuni per gli snapshot.
+
