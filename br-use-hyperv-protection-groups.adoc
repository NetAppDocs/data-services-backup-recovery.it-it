...
. Modificare le impostazioni del gruppo di protezione, ad esempio il nome o le macchine virtuali presenti nel gruppo.
. Selezionare *Avanti*.
. Se necessario, modificare la politica di protezione. Al termine, seleziona *Avanti*.
