...
+
*Riavvia la macchina virtuale*: abilita questa opzione per avviare la nuova macchina virtuale dopo il suo ripristino.
...
--
Non disponibile per l'anteprima dei carichi di lavoro Hyper-V.
