...
* Ripristina da un backup di storage a oggetti (solo nella posizione originale)



NOTE: Il ripristino da backup dell'archivio di oggetti non è supportato per le macchine virtuali che risiedono su storage SAN.
...
* Ripristina in una posizione alternativa (dallo storage primario e secondario)
