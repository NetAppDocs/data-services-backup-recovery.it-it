...
---
= Ripristina le applicazioni Kubernetes con NetApp Backup and Recovery utilizzando una risorsa personalizzata
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
* È possibile utilizzare le impostazioni avanzate per personalizzare le operazioni di ripristino. Per saperne di più, consulta link:br-use-kubernetes-advanced-restore-settings.html["Impostazioni di ripristino avanzate per Kubernetes in NetApp Backup and Recovery"].
