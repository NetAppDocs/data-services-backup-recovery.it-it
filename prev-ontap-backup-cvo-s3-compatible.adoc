...
* Testato e convalidato con Wasabi storage a oggetti; i clienti hanno inoltre segnalato implementazioni riuscite con MinIO, IBM Cloud Object Storage e Apple Object Store
