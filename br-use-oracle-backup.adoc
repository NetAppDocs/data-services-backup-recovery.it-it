...
summary: Proteggi i carichi di lavoro del tuo database Oracle con NetApp backup e ripristino. 
---
...
* Crea gruppi di protezione per gestire le operazioni di backup e ripristino per un set di risorse. Vedi link:br-use-kvm-protection-groups.html["Crea e gestisci gruppi di protezione per i carichi di lavoro di Oracle Database con NetApp Backup and Recovery"] per ulteriori informazioni.
