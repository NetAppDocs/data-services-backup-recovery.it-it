...
---
= Configura i certificati di sicurezza per NetApp Backup and Recovery
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Se la comunicazione tra i container di NetApp Backup and Recovery e StorageGRID deve verificare il certificato StorageGRID, completa i seguenti passaggi.
