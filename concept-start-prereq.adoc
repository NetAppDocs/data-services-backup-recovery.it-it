...
| ASP.NET Core Runtime | 8.0.23 Hosting Bundle (e tutte le successive patch 8.0.x) 
...
* ONTAP 9.13.1 o successivo
* Amazon FSx for NetApp ONTAP storage systems che eseguono la versione 9.13.1 o successiva
* Archiviazione SAN (anteprima) (supportata per backup e ripristino nella posizione originale da storage primario e secondario)
