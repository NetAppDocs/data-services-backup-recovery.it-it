...
È inoltre possibile seguire questi passaggi per sostituire l'agente della Console e ripristinare i dati di configurazione archiviati su di esso quando si utilizza Backup and Recovery in  on-premises senza account cloud (ad esempio, quando si utilizza NetApp StorageGrid come destinazione di backup).
