...
---
= Scopri come gestire i carichi di lavoro Kubernetes con NetApp Backup and Recovery
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
La gestione dei carichi di lavoro Kubernetes in NetApp Backup and Recovery consente di individuare, gestire e proteggere i cluster e le applicazioni Kubernetes, tutto in un unico posto. È possibile gestire risorse e applicazioni ospitate sui cluster Kubernetes. È inoltre possibile creare e associare policy di protezione alle applicazioni Kubernetes, il tutto tramite un'unica interfaccia.
