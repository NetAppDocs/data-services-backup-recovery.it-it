...
*Ruolo richiesto nella NetApp Console* Ruolo di super amministratore di Backup e Recovery o ruolo di amministratore di ripristino di Backup e Recovery. Se proteggi dati archiviati su un cluster Cloud Volumes ONTAP, è richiesto anche il ruolo di Cloud Volumes ONTAP Admin. https://docs.netapp.com/us-en/console-setup-admin/reference-iam-predefined-roles.html["Scopri di più sui ruoli di accesso NetApp Console per tutti i servizi"^]
